...
// DATATABLES BON DE CAISSE PROJET
$(function() {
...
$(function() {
    $('#dataCAISSE3').DataTable({
        ...
        rowGroup: {
            startRender: function(rows, group) {
                return $('<tr/>').append(
                    '<td colspan="11" class="col-blue bolo700" style="background-color: #dbdfef">' + group + '</td>',
                )
            },
            dataSrc: 10,
        },
...
$('#addDeplacerCaisse').on("click" , function(event) {
    event.preventDefault()
    var id = $('#idcaisse').val()
    var idchantier = $('#deplacerCaisse').val()
