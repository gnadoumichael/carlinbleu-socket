...
$(document).ready(function() {
    $('#dataARTY').DataTable({
        ...
        rowGroup: {
            startRender: function(rows, group) {
                return $('<tr/>').append(
                    '<td colspan="5" class="bg-gray-300 text-pri"  style="color: #4e73df !important;">' +
                    group +
                    '</td>',
                )
            },
    ...
    $('#dataRECAP').DataTable({
        ...
        rowGroup: {
            startRender: function (rows, group) {
                ...
                return $('<tr/>')
                    .append(
                        '<td class="col-blue bolo700" style="background-color: #dbdfef">' +
                        group +
                        '</td>',
                    )
                    .append(
                        '<td class="col-blue bolo700 text-right" style="background-color: #dbdfef">' +
                        qte +
                        '</td>',
                    )
                    .append(
