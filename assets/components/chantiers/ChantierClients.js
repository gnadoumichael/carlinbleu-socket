...
const ChantierClients = () => {
    ...
    if (length === 0 && $('#jsonclients').val() !== undefined) {
        axios({
            method: 'GET',
            url: '/crm/chantiers/getdatassAAA/clients',
                    ...
                    action: function (e, dt, node, config) {
                        $("input:checkbox[class='CLYE']:checked").each(async function () {
                            ...
                            await axios({
                                ...
                                setDatas(response.data);
                                $('#dataClientes').DataTable().ajax.reload();
    ...
    return (
        <>
            ...
            <h4 className="col-blue bolo600 loaditi m-t--20">Chargement de vos données <img src={logo} width="30"
                                                                                            height="30"/></h4>
                ...
                <div className="block-header">
                    ...
                    <div className="panel-group" id="accordion_1" role="tablist"
                        ...
                        <div className="panel panel-grey  dadclients shadow">
                            ...
                            <div id="collapseOne_0" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingOne_0">
                                <div className="panel-body">
                                    <div className="table-responsive shadow"
                                         style={{padding: "20px", overflow: "scroll"}}>
                                        <table className="table-bordered  display nowrap" id="dataClientes"
                                               style={{width: "100%"}}>
                                            <thead>
                                            <tr>
                        ...
                        <div className="panel panel-grey  dadcours shadow" style={{marginTop: "20px"}}>
                            <div className="panel-heading" role="tab" id="headingOne_1p">
                                <h5 className="panel-title">
                                    <a className="collapsed outai col-white" role="button"
                                       data-toggle="collapse"
                                       data-parent="#accordion_1p" href="#collapseOne_1p"
                                       aria-expanded="false"
                                       aria-controls="collapseOne_1p">
                                        <i className="material-icons col-white"
                                           style={{fontSize: "18px", float: "left"}}>keyboard_arrow_down</i>Chantiers
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseOne_1p" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingOne_1p">
                                <div className="panel-body">
                                    <div className="table-responsive shadow"
                                         style={{padding: "20px", overflow: "scroll"}}>
                                        <div className="row m-b-15 ">
                                            <table className="table-bordered shadow display nowrap"
                                                   id="dataCours" width="100%">
                                                <thead>
                                                <tr className="font-weight-normal">
                                                    <th className="mw30"/>
                                                    <th className="col-blue-grey mw270 sortable tleft">CHANTIERS
                                                        / CLIENT
                                                    </th>
                                                    <th className="col-blue-grey mw250 sortable hide tleft">CLIENT</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">COÛT&nbsp;DU&nbsp;CHANTIER</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">RÈGLEMENT</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">SOLDE</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">DÉPENSES</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">MARGES</th>
                                                    <th className="text-center col-blue-grey mw120 sortable tleft">BALANCE</th>
                                                </tr>
                                                </thead>
                                                <tbody></tbody>
                                                <tfoot>
                                                <tr className="font-weight-normal">
                                                    ...
                                                    <th className="bg-blue"></th>
                                                    <th className="bg-blue"></th>
                                                    <th className="bg-blue nowrap"></th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                        ...
                        <div className="panel panel-grey  dadsous shadow">
                            <div className="panel-heading" role="tab" id="headingOne_1s">
                                <h5 className="panel-title">
                                    <a className="collapsed outai  col-white" role="button" data-toggle="collapse"
                                       ...
                                       aria-controls="collapseOne_1s">
                                        <i className="material-icons col-white"
                                           style={{fontSize: "18px", float: "left"}}>keyboard_arrow_down</i>Sous-chantiers
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseOne_1s" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingOne_1s">
                                <div className="panel-body" style={{overflow: "scroll"}}>
                                    <div className="table-responsive shadow" style={{padding: "20px"}}>
                                        <table className="table-bordered shadow display nowrap" id="dataSous"
                                               width="100%">
                                            <thead>
                                            <tr className="font-weight-normal">
                                                <th className="mw30"/>
                                                <th className="col-blue-grey mw260">CHANTIER/SOUS-CHANTIERS</th>
                                                <th className="text-center col-blue-grey mw100">COÛT</th>
                                                <th className="text-center col-blue-grey">CHANTIER</th>
                                                <th className="text-center col-blue-grey mw100">RÈGLEMENT</th>
                                                <th className="text-center col-blue-grey mw100">SOLDE</th>
                                                <th className="text-center col-blue-grey mw100">DÉPENSES</th>
                                                <th className="text-center col-blue-grey mw100">MARGES</th>
                                                <th className="text-center col-blue-grey mw100">BALANCE</th>
                                            </tr>
                                            </thead>
                                            <tbody></tbody>
                                        </table>
                        ...
                        <div className="panel panel-grey  dadarchiver shadow">
                            ...
                            <div id="collapseTwo_1" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingTwo_1">
                                <div className="panel-body" style={{overflow: "scroll"}}>
                                    <div className="table-responsive shadow" style={{padding: "20px"}}>
                                        <table className="table-bordered shadow display nowrap" id="dataArchive"
                                               width="100%">
                                            <thead>
                                            <tr className="font-weight-normal">
                                                <th className="mw30"/>
                                                <th className="col-blue-grey mw250">CHANTIERS / CLIENT</th>
                                                <th className="text-center col-blue-grey mw100">COÛT</th>
                                                <th className="text-center col-blue-grey">CLIENT</th>
                                                <th className="text-center col-blue-grey mw100">RÈGLEMENT</th>
                                                <th className="text-center col-blue-grey mw100">SOLDE</th>
                                                <th className="text-center col-blue-grey mw100">DÉPENSES</th>
                                                <th className="text-center col-blue-grey mw100">MARGES</th>
                        ...
                        <div className="panel panel-grey  dadterminer shadow">
                            <div className="panel-heading" role="tab" id="headingThree_1">
                                <h4 className="panel-title">
                                    <a className="collapsed col-white outai" role="button" data-toggle="collapse"
                                       data-parent="#accordion_1" href="#collapseThree_1" aria-expanded="false"
                                       aria-controls="collapseThree_1">
                                        <i className="material-icons col-white"
                                           style={{fontSize: "18px", float: "left"}}>keyboard_arrow_down</i>Tous
                                        les chantiers
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseThree_1" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingThree_1">
                                <div className="panel-body" style={{overflow: "scroll"}}>
                                    <div className="table-responsive shadow" style={{padding: "20px"}}>
                                        <table className="table-bordered shadow display nowrap" id="dataTerminer"
                                               width="100%">
                                            <thead>
                                            <tr className="font-weight-normal">
                                                <th className="mw30"></th>
                                                <th className="col-blue-grey mw250">CHANTIERS / CLIENT</th>
                                                <th className="text-center col-blue-grey mw100">COÛT&nbsp;DU&nbsp;CHANTIER</th>
                                                <th className="text-center col-blue-grey">CLIENT</th>
                                                <th className="text-center col-blue-grey mw100">RÈGLEMENT</th>
                                                <th className="text-center col-blue-grey mw100">SOLDE</th>
                                                <th className="text-center col-blue-grey mw100">DÉPENSES</th>
                        ...
                        <div className="panel panel-grey  dadcontacts shadow" style={{marginTop: "20px"}}>
                            <div className="panel-heading" role="tab" id="headingDeu">
                                <h5 className="panel-title ">
                                    <a className="collapsed outai col-white" role="button"
                                       data-toggle="collapse"
                                       ...
                                       aria-controls="collapseDeu">
                                        <i className="material-icons col-white"
                                           style={{fontSize: "18px", float: "left"}}>keyboard_arrow_down</i>Contacts
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseDeu" className="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingDeu">
                                <div className="panel-body" style={{overflow: "scroll"}}>
                                    <div className="table-responsive shadow" style={{padding: "10px"}}>
                                        <table className="table-striped table-bordered display nowrap"
                                               width="100%"
                                               id="dataContocts">
                                            <thead>
                                            <tr className="text-center">
                                                <th className="mw30"/>
                                                <th className="mw200">CONTACT</th>
                                                <th>FONCTION</th>
                                                <th>EMAIL</th>
                                                <th>TÉLÉPHONE</th>
                                                <th>BUREAU</th>
