        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    if (false === $("input[class='MESSAS']").prop('checked')) {
                        $("input[class='MESSAS']").prop('checked', true)
                    } else {
                        $("input[class='MESSAS']").prop('checked', false)
                    }
                },
            ...
            },
            {
                ...
                className: 'del',
                action: function (e, dt, node, config) {
                    $("input:checkbox[class='MESSAS']:checked").each(function () {
                        const id = $(this).val();
