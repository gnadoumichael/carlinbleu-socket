$(function () {
    ...
    $('#dataDepenses').DataTable({
        ...
        lengthMenu: [
            [20, 80, 160, 240, 320, 420, -1],
            ['20', '80', '160', '240', '320', '420', 'Tout'],
        ],
        "drawCallback": function (row, data, start, end, display) {
            ...
            let de = api.column(2).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(2).footer().innerHTML = formatNumber(pageTotal, '2', " ") + " sur <br>" + formatNumber(de, '2', " ");
        }
    });
    $('#dataCredit').DataTable({
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            let de = api.column(3).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(3).footer().innerHTML = formatNumber(pageTotal, '2', " ") + " sur <br>" + formatNumber(de, '2', " ");
        }
    });
    $('#dataCaissers').DataTable({
        retrieve: true,
        fixedHeader: {
            header: true,
            footer: true,
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            let der = api.column(2).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(2).footer().innerHTML = formatNumber(pageTotale, '2', " ") + " sur <br>" + formatNumber(der, '2', " ");
            api.column(3).footer().innerHTML = formatNumber(pageTotal, '2', " ") + " sur <br>" + formatNumber(de, '2', " ");
        }
    });
    $('#dataJOURNALE').DataTable({
        retrieve: true,
        fixedHeader: {
            header: true,
            footer: true,
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            api.column(3).footer().innerHTML = formatNumber(de, '2', " ");
        }
    });
    $('#chanchane').off().on("change", async function () {
        let id = $('#chanchane option:selected').val();
        window.location.href = '/crm/budget/chchan/' + id
    });
    $('#chdevis').off().on("change", async function () {
        let id = $('#chdevis option:selected').val();
        window.location.href = '/crm/budget/chdevis/' + id
    });
    ...
    $('#dCAISSE').DataTable({
        ...
        rowGroup: {
            startRender: function (rows, group) {
                return $('<tr/>').append(
                    '<td class="col-blue bolo700" style="background-color: #dbdfef" colspan="11">' +
                    group +
                    '</td>',
                )
            },
    ...
    $('#dCAISSEP').DataTable({
        ...
        buttons: [{
            ...
            className: 'fred2',
            action: function (e, dt, node, config) {
                if (false === $("input[class='CSSE']").prop('checked')) {
                    $("input[class='CSSE']").prop('checked', true)
                } else {
                    $("input[class='CSSE']").prop('checked', false)
                }
            },
            titleAttr: 'Cocher tout /  Décocher tout',
        },
            {
                ...
                className: 'valider',
                action: function (e, dt, node, config) {
                    $("input:checkbox[class='CSSE']:checked").each(function () {
                        var idcaisse = $(this).val()
                        $('#Traitement').modal('show')
                        $.ajax({
                            type: 'GET',
        ...
        rowGroup: {
            startRender: function (rows, group) {
                ...
                return $('<tr/>').append(
                    '<td class="col-blue bolo700" style="background-color: #dbdfef" colspan="4">' + group + '</td>',
                    '<td class="col-blue bolo700" style="background-color: #dbdfef; text-align:right">' + valeur + '</td>',
                    '<td class="col-blue bolo700" style="background-color: #dbdfef" colspan="4"></td>',
                )
            },
            dataSrc: 0,
        },
    ...
    $('#dCAISSEP2').DataTable({
        ...
        buttons: [{
            ...
            className: 'fred2',
            action: function (e, dt, node, config) {
                if (false === $("input[class='CSSE2']").prop('checked')) {
                    $("input[class='CSSE2']").prop('checked', true)
                } else {
                    $("input[class='CSSE2']").prop('checked', false)
                }
            },
            titleAttr: 'Cocher tout /  Décocher tout',
        },
            {
                ...
                className: 'valider',
                action: function (e, dt, node, config) {
                    $("input:checkbox[class='CSSE2']:checked").each(function () {
                        var idcaisse = $(this).val()
                        $('#Traitement').modal('show')
                        $.ajax({
                            type: 'GET',
        ...
        buttons: [
            {
                ...
                className: 'fred2',
                action: function (e, dt, node, config) {
                    if (false === $("input[class='CASS3']").prop('checked')) {
                        $("input[class='CASS3']").prop('checked', true)
                    } else {
                        $("input[class='CASS3']").prop('checked', false)
                    }
                },
                titleAttr: 'Cocher tout /  Décocher tout',
            },
            {
                ...
                className: 'valider',
                action: function (e, dt, node, config) {
                    $("input:checkbox[class='CASS3']:checked").each(function () {
                        var idcaisse = $(this).val()
                        $('#Traitement').modal('show')
                        $.ajax({
                            type: 'GET',
    ...
    $('#dataRELEVA').DataTable({
        ...
        rowGroup: {
            startRender: function (rows, group) {
                return $('<tr/>').append(
                    '<td colspan="4" class="bg-gray bolo700" style="color: #4e73df !important;">' +
                    group +
                    '</td>',
                )
            },
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            let th = api.column(3).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(3).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(th);
        }
    })
...
$('#adduCaisse').off().on("click", function (event) {
    ...
    if ($(this).closest('form').valid()) {
        ...
        $('#editor17').val(CKEDITOR.instances['editor17'].getData());
        $.ajax({
            type: 'POST',
...
$('#addiCaisse').off().on("click", function (event) {
    event.preventDefault()
    if ($(this).closest('form').valid()) {
        $('#addiCaisse').hide()
        $('#closiCaisse').hide()
        $('#loadiCaisse').css('display', '')
        $('#editor16').val(CKEDITOR.instances['editor16'].getData())
        $.ajax({
            type: 'POST',
            url: '/crm/caisse/addprestataire',
            data: JSON.stringify($('#addCaissePretataireForm').serializeObject()),
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (respdata, textStatus, jqXHR) {
                window.location.href = '/crm/caisse/' + respdata['result'][0]['numcaisse'] + '/' + respdata['result'][0]['idchantier']
...
$('#addxCaisse').off().on("click", function (event) {
    ...
    if ($(this).closest('form').valid()) {
        ...
        $('#editor16').val(CKEDITOR.instances['editor16'].getData())
        $('#editor18').val(CKEDITOR.instances['editor18'].getData())
        $.ajax({
            type: 'POST',
            url: '/crm/caisse/addprestataire',
...
$('#adduuCaisse').off().on("click", function (event) {
    ...
    if ($(this).closest('form').valid()) {
        ...
        $.ajax({
            type: 'POST',
            url: '/crm/caisse/addprestataire',
            data: JSON.stringify($('#addCaissePrestaToken').serializeObject()),
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (respdata, textStatus, jqXHR) {
                    $('#modalCaisse').modal('toggle')
...
$('#sefone').off().on("change", function (event) {
    ...
    $.ajax({
        type: 'POST',
        url: '/crm/bon/fournisseur/' + this.value + "/" + idchantier,
        contentType: 'application/json; charset=utf-8',
        success: function (respdata, textStatus, jqXHR) {
            $(".dibon").empty();
...
$('#sefona').off().on("change", function (event) {
    event.preventDefault();
    const $selbona = $('.selbona');
    const idchantier = $('#idchantier').val();
    ...
    $.ajax({
        ...
        success: function (respdata, textStatus, jqXHR) {
            ...
            $(".dibona").append('<span class="col-pink">Chargement des bons</span> <img src="/img/loading.gif" style="width: 20px">');
            let gr = $('<option selected>Veuillez choisir un bon svp !</option>');
            gr.appendTo($selbona);
            respdata.map((bo) => {
                if(bo.reste >0){
                    let group = $('<option value=' + bo.id + '>Bon Nº ' + bo.numbon + ' | ' + bo.client.nomclient + ' | TTC: ' + bo.totalttc + '</option>');
                    group.appendTo($selbona);
                    $('#prestamontant').val(bo.totalttc)
                }
            });
            $(".dibona").empty();
            $(".dibona").append('<span class="col-green">Bons téléchargés</span>');
        },
        error: function (xhr, resp, text) {
            $('#ModalErreur').modal('show')
        },
