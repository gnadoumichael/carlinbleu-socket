...
$(function () {
    ...
    $('#dataBONPST').DataTable({
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            let th = api.column(4).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            let ttc = api.column(5).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            let recu = api.column(8).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            let reste = api.column(9).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(4).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(th);
            api.column(5).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(ttc);
            api.column(8).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(recu);
            api.column(9).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(reste);
