    ...
    $('#dataDEVIS').DataTable({
        ...
        rowGroup: {
            startRender: function (rows, group) {
                return $('<tr/>').append(
                    '<td colspan="12" class="col-blue bolo700" style="background-color: #dbdfef">' +
                    group +
                    '</td>',
                )
            },
        ...
        "drawCallback": function (row, data, start, end, display) {
            ...
            let regler = api.column(7).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            let solde = api.column(8).data().reduce(function (a, b) {
                b = b.split(' ').join('')
                b = b.split(',').join('.')
                b = parseFloat(b)
                return a + b
            ...
            api.column(7).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(regler);
            api.column(8).footer().innerHTML = $.fn.dataTable.render.number(' ', ',', 2, '').display(solde);
