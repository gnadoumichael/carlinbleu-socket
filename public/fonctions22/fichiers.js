        ...
        buttons: [
            {
                ...
                className: 'fred2',
                action: function (e, dt, node, config) {
                    if (false === $("input[class='FICHO']").prop('checked')) {
                        $("input[class='FICHO']").prop('checked', true)
                    } else {
                        $("input[class='FICHO']").prop('checked', false)
                    }
                },
                titleAttr: 'Cocher tout /  Décocher tout',
            },
            {
                ...
                className: 'del',
                action: function (e, dt, node, config) {
                    $("input:checkbox[class='FICHO']:checked").each(function () {
                        const id = $(this).val();
                        $('#ConfirmDelete').modal('show')
                        $('#accept').click(function () {
                            $('#ConfirmDelete').modal('hide')
