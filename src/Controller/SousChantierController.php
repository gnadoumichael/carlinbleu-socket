...
#[Route(path: '/crm/souschantier')]
class SousChantierController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'souschantier')]
    #[Route(path: '/{id}', name: 'editsouschantier', requirements: ['id' => '\d+'])]
    public function chancours(int $id = null)
    {
        ...
        return $this->render('content/chansous.html.twig', [
