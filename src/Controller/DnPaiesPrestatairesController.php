...
#[Route(path: '/crm/dnpaiesprestataires')]
class DnPaiesPrestatairesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dnpaiesprestataires')]
    public function paiespresta()
    {
        ...
        return $this->render('content/dnpaiesprestataires.html.twig', [
            'title' => 'Chantiers | Carlinbleu',
            'master' => $this->getMaster(),
            'estmaster' => $this->getMaster() === $this->getUser(),
            'page' => 'paiesprestataires',
            'jsonclients' => true,
            'history' => $historiques,
