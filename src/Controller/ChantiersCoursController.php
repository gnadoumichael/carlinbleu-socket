...
#[Route(path: '/crm/chantiercours')]
class ChantiersCoursController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chancours')]
    #[Route(path: '/{id}', name: 'editcours', requirements: ['id' => '\d+'])]
    public function chancours(int $id = null)
    {
        ...
        return $this->render('content/chancours.html.twig', [
