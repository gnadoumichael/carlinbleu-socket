...
#[Route(path: '/crm/chantierechouer')]
class ChantiersEchouesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chanechouer')]
    #[Route(path: '/{id}', name: 'editechouer', requirements: ['id' => '\d+'])]
    public function chanechouer(int $id = null)
    {
        ...
        return $this->render('content/chanechouer.html.twig', [
