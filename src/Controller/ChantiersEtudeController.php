...
#[Route(path: '/crm/chantieretude')]
class ChantiersEtudeController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chanetude')]
    #[Route(path: '/{id}', name: 'editetude', requirements: ['id' => '\d+'])]
    public function chantieretude(int $id = null)
    {
        ...
        return $this->render('content/chanetude.html.twig', [
