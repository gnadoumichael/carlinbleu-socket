...
#[Route(path: '/crm/dndecomptes')]
class DnDecomptesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dndecomptes')]
    public function dndecomptes(int $id = null)
    {
        ...
        return $this->render('content/dndecomptes.html.twig', [
