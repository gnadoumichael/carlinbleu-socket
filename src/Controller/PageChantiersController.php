...
#[Route(path: '/crm/pagechantiers')]
class PageChantiersController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'pagechantiers')]
    #[Route(path: '/{id}', name: 'edichantiers', requirements: ['id' => '\d+'])]
    public function pagechantiers(int $id = null)
    {
        ...
        return $this->render('contente/pagechantiers.html.twig', [
