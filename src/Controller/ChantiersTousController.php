...
#[Route(path: '/crm/chantierstous')]
class ChantiersTousController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chantous')]
    #[Route(path: '/{id}', name: 'edittous', requirements: ['id' => '\d+'])]
    public function chantous(int $id = null)
    {
        ...
        return $this->render('content/chantous.html.twig', [
