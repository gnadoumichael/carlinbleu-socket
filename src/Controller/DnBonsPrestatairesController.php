...
#[Route(path: '/crm/dnbonsprestataires')]
class DnBonsPrestatairesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dnbonsprestataires')]
    public function bonprestatairespage()
    {
        ...
        return $this->render('content/dnbonsprestataires.html.twig', [
            'title' => 'Chantiers | Carlinbleu',
            'master' => $this->getMaster(),
            'estmaster' => $this->getMaster() === $this->getUser(),
            'page' => 'dnbonsprestataires',
            'jsonclients' => true,
            'history' => $historiques,
