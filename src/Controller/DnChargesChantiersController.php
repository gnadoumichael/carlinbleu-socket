...
#[Route(path: '/crm/dnchargeschantiers')]
class DnChargesChantiersController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dnchargeschantiers')]
    public function bonprestatairespage()
    {
        ...
        return $this->render('content/dnchargeschantiers.html.twig', [
            'title' => 'Chantiers | Carlinbleu',
            'master' => $this->getMaster(),
            'estmaster' => $this->getMaster() === $this->getUser(),
            'page' => 'dnchargeschantiers',
            'jsonclients' => true,
            'history' => $historiques,
