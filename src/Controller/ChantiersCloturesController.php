...
#[Route(path: '/crm/chantiersclotures')]
class ChantiersCloturesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chanclotures')]
    #[Route(path: '/{id}', name: 'editclotures', requirements: ['id' => '\d+'])]
    public function chantermines(int $id = null)
    {
        ...
        return $this->render('content/chanclotures.html.twig', [
