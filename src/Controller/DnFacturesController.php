...
#[Route(path: '/crm/dnfactures')]
class DnFacturesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dnfactures')]
    public function dnfactures(int $id = null)
    {
        ...
        return $this->render('content/dnfactures.html.twig', [
