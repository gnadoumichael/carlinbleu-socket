...
#[Route(path: '/crm/dnbonsfournisseurs')]
class DnBonsFournisseursController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dnbonsfournisseurs')]
    public function bonfournisseurspage()
    {
        ...
        return $this->render('content/dnbonsfournisseurs.html.twig', [
            'title' => 'Chantiers | Carlinbleu',
            'master' => $this->getMaster(),
            'estmaster' => $this->getMaster() === $this->getUser(),
            'page' => 'dnbonsfournisseurs',
            'jsonclients' => true,
            'history' => $historiques,
