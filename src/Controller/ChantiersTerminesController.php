...
#[Route(path: '/crm/chantierstermines')]
class ChantiersTerminesController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'chantermines')]
    #[Route(path: '/{id}', name: 'edittermines', requirements: ['id' => '\d+'])]
    public function chantermines(int $id = null)
    {
        ...
        return $this->render('content/chantermines.html.twig', [
