 ...
 */
class getBonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BonRepository' shared autowired service.
     *
     * @return \App\Repository\BonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BonRepository.php';

        return $container->privates['App\\Repository\\BonRepository'] = new \App\Repository\BonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
