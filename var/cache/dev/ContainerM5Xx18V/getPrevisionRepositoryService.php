 ...
 */
class getPrevisionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrevisionRepository' shared autowired service.
     *
     * @return \App\Repository\PrevisionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrevisionRepository.php';

        return $container->privates['App\\Repository\\PrevisionRepository'] = new \App\Repository\PrevisionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
