 ...
 */
class getTechnicienRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TechnicienRepository' shared autowired service.
     *
     * @return \App\Repository\TechnicienRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TechnicienRepository.php';

        return $container->privates['App\\Repository\\TechnicienRepository'] = new \App\Repository\TechnicienRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
