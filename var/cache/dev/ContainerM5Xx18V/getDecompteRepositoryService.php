 ...
 */
class getDecompteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DecompteRepository' shared autowired service.
     *
     * @return \App\Repository\DecompteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DecompteRepository.php';

        return $container->privates['App\\Repository\\DecompteRepository'] = new \App\Repository\DecompteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
