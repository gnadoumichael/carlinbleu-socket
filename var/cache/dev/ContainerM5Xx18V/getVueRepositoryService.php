 ...
 */
class getVueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VueRepository' shared autowired service.
     *
     * @return \App\Repository\VueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VueRepository.php';

        return $container->privates['App\\Repository\\VueRepository'] = new \App\Repository\VueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
