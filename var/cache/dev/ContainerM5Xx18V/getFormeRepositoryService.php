 ...
 */
class getFormeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormeRepository' shared autowired service.
     *
     * @return \App\Repository\FormeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormeRepository.php';

        return $container->privates['App\\Repository\\FormeRepository'] = new \App\Repository\FormeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
