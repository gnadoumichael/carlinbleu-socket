 ...
 */
class getDevisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DevisRepository' shared autowired service.
     *
     * @return \App\Repository\DevisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DevisRepository.php';

        return $container->privates['App\\Repository\\DevisRepository'] = new \App\Repository\DevisRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
