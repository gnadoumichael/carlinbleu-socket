 ...
 */
class getAcompteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcompteRepository' shared autowired service.
     *
     * @return \App\Repository\AcompteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcompteRepository.php';

        return $container->privates['App\\Repository\\AcompteRepository'] = new \App\Repository\AcompteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
