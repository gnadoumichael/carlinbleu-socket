 ...
 */
class getMathistoriqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MathistoriqueRepository' shared autowired service.
     *
     * @return \App\Repository\MathistoriqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MathistoriqueRepository.php';

        return $container->privates['App\\Repository\\MathistoriqueRepository'] = new \App\Repository\MathistoriqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
