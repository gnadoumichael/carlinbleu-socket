 ...
 */
class getExercicesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExercicesRepository' shared autowired service.
     *
     * @return \App\Repository\ExercicesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExercicesRepository.php';

        return $container->privates['App\\Repository\\ExercicesRepository'] = new \App\Repository\ExercicesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
