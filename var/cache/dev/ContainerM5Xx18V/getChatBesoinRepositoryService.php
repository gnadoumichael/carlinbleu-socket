 ...
 */
class getChatBesoinRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChatBesoinRepository' shared autowired service.
     *
     * @return \App\Repository\ChatBesoinRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChatBesoinRepository.php';

        return $container->privates['App\\Repository\\ChatBesoinRepository'] = new \App\Repository\ChatBesoinRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
