 ...
 */
class getLienRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LienRepository.php';

        return $container->privates['App\\Repository\\LienRepository'] = new \App\Repository\LienRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
