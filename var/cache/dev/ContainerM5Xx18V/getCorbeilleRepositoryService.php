 ...
 */
class getCorbeilleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CorbeilleRepository' shared autowired service.
     *
     * @return \App\Repository\CorbeilleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CorbeilleRepository.php';

        return $container->privates['App\\Repository\\CorbeilleRepository'] = new \App\Repository\CorbeilleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
