 ...
 */
class getReleverRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReleverRepository' shared autowired service.
     *
     * @return \App\Repository\ReleverRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReleverRepository.php';

        return $container->privates['App\\Repository\\ReleverRepository'] = new \App\Repository\ReleverRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
