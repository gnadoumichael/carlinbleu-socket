 ...
 */
class getCarlinbleuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarlinbleuRepository' shared autowired service.
     *
     * @return \App\Repository\CarlinbleuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarlinbleuRepository.php';

        return $container->privates['App\\Repository\\CarlinbleuRepository'] = new \App\Repository\CarlinbleuRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
