 ...
 */
class getCaisseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CaisseRepository' shared autowired service.
     *
     * @return \App\Repository\CaisseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CaisseRepository.php';

        return $container->privates['App\\Repository\\CaisseRepository'] = new \App\Repository\CaisseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
