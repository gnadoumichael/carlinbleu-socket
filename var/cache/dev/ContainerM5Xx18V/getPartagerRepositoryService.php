 ...
 */
class getPartagerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PartagerRepository' shared autowired service.
     *
     * @return \App\Repository\PartagerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PartagerRepository.php';

        return $container->privates['App\\Repository\\PartagerRepository'] = new \App\Repository\PartagerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
