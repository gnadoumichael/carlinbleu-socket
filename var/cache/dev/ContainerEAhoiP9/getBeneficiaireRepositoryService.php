 ...
 */
class getBeneficiaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BeneficiaireRepository' shared autowired service.
     *
     * @return \App\Repository\BeneficiaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BeneficiaireRepository.php';

        return $container->privates['App\\Repository\\BeneficiaireRepository'] = new \App\Repository\BeneficiaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
