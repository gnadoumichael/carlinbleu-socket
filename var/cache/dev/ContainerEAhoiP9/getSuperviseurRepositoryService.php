 ...
 */
class getSuperviseurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuperviseurRepository' shared autowired service.
     *
     * @return \App\Repository\SuperviseurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuperviseurRepository.php';

        return $container->privates['App\\Repository\\SuperviseurRepository'] = new \App\Repository\SuperviseurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
