...
class get_ServiceLocator_UVvF4gLService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.uVvF4gL'])) {
            return $container->privates['.service_locator.uVvF4gL'];
        }

        return $container->privates['.service_locator.uVvF4gL'] = $instance;
    }
}
