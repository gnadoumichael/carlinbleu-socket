 ...
 */
class getChefRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChefRepository' shared autowired service.
     *
     * @return \App\Repository\ChefRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChefRepository.php';

        return $container->privates['App\\Repository\\ChefRepository'] = new \App\Repository\ChefRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
