 ...
 */
class getAlerteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AlerteRepository' shared autowired service.
     *
     * @return \App\Repository\AlerteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AlerteRepository.php';

        return $container->privates['App\\Repository\\AlerteRepository'] = new \App\Repository\AlerteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
