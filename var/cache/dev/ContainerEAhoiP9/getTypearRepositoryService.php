 ...
 */
class getTypearRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypearRepository' shared autowired service.
     *
     * @return \App\Repository\TypearRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypearRepository.php';

        return $container->privates['App\\Repository\\TypearRepository'] = new \App\Repository\TypearRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
