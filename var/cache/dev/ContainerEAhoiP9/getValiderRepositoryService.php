 ...
 */
class getValiderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ValiderRepository' shared autowired service.
     *
     * @return \App\Repository\ValiderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ValiderRepository.php';

        return $container->privates['App\\Repository\\ValiderRepository'] = new \App\Repository\ValiderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
