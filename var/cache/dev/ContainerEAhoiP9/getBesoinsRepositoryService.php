 ...
 */
class getBesoinsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BesoinsRepository' shared autowired service.
     *
     * @return \App\Repository\BesoinsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BesoinsRepository.php';

        return $container->privates['App\\Repository\\BesoinsRepository'] = new \App\Repository\BesoinsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
