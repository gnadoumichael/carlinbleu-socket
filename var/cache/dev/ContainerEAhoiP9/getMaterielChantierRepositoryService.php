 ...
 */
class getMaterielChantierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaterielChantierRepository' shared autowired service.
     *
     * @return \App\Repository\MaterielChantierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaterielChantierRepository.php';

        return $container->privates['App\\Repository\\MaterielChantierRepository'] = new \App\Repository\MaterielChantierRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
