 ...
 */
class getMaterielBeneficiaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaterielBeneficiaireRepository' shared autowired service.
     *
     * @return \App\Repository\MaterielBeneficiaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaterielBeneficiaireRepository.php';

        return $container->privates['App\\Repository\\MaterielBeneficiaireRepository'] = new \App\Repository\MaterielBeneficiaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
