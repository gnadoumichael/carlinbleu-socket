 ...
 */
class getRecapRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecapRepository' shared autowired service.
     *
     * @return \App\Repository\RecapRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecapRepository.php';

        return $container->privates['App\\Repository\\RecapRepository'] = new \App\Repository\RecapRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
