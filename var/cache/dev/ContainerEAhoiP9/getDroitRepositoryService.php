 ...
 */
class getDroitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DroitRepository' shared autowired service.
     *
     * @return \App\Repository\DroitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DroitRepository.php';

        return $container->privates['App\\Repository\\DroitRepository'] = new \App\Repository\DroitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
