 ...
 */
class getGestionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GestionRepository' shared autowired service.
     *
     * @return \App\Repository\GestionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GestionRepository.php';

        return $container->privates['App\\Repository\\GestionRepository'] = new \App\Repository\GestionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
